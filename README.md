...
| 2 | Micro | Haiku 4.5 (SPEC-010) | 영업일 07:30 + 장중 캐시 | 종목·섹터 매수/매도/관망 후보 |
...
| 뉴스 인텔리전스 분석 비용 (SPEC-014) | 월 0원 (Claude Code CLI, Max 구독 포함) |
...
- **Claude Code CLI**: SPEC-014 뉴스 인텔리전스 분석 (호스트 cron, Max 구독)
...
_마지막 업데이트: 2026-05-06 — SPEC-009~014 반영 (뉴스 인텔리전스 파이프라인 + Claude Code CLI 분석)_
